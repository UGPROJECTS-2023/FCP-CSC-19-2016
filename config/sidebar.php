...
<aside class="main-sidebar sidebar-dark-primary bg-black elevation-4">
    <a href="./" class="brand-link logo-switch bg-black">
      <h4 class="brand-image-xl logo-xs mb-0 text-center"><b>FUD</b></h4>
      <h4 class="brand-image-xl logo-xl mb-0 text-center">FUD CLINIC MANAGEMENT SYSTEM <b>FUD</b></h4>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" id="mnu_patients">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="lab_records.php" class="nav-link" 
                id="mi_new_prescription">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lab Records</p>
                </a>
